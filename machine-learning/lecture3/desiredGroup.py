...
x, y = pf.importDataset(test_x, dependency_nstd, mu, scale)
plotAxises.scatter(x, y, s=1, marker='s', c='red')

x, y = pf.importDataset(test_y, dependency_nstd, mu, scale)
plotAxises.scatter(x, y, s=1, marker='o', c='green')
