waterSupplyNetwork MATLAB Python Package
...
Verify that a Windows version of Python 3.9, 3.10, and/or 3.11 is installed.

2. Installing the waterSupplyNetwork Package

A. Change to the directory that contains the file setup.py and the subdirectory 
waterSupplyNetwork. If you do not have write permissions, copy all its contents to a 
...
3. Using the waterSupplyNetwork Package

The waterSupplyNetwork package is on your Python path. To import it into a Python script 
or session, execute:
